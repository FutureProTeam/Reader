...
class CoreThread extends Thread {
     ...
     */
    CoreThread(int port, int timeout, Map<String, RequestHandler> handlerMap, HttpRequestHandler noMatchHttpRequestHandler, WebSite webSite, Server.Listener listener) {
        this.mPort = port;
    ...
    private HttpRequestHandlerResolver registerRequestHandler() {
        HttpRequestHandlerRegistry handlerRegistry = new CoreHttpRequestHandlerRegistry(new HttpRequestHandlerRegistry(),noMatchHttpRequestHandler);
