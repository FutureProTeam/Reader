...
import com.futureproteam.reader.andserver.NoMatchHttpRequestHandler;
...
public class AndServer {
    ...
    private AndServer(Build build) {
        ...
        this.noMatchHttpRequestHandler = build.noMatchHttpRequestHandler;
    }
    ...
    public Server createServer() {
        return new DefaultServer(mPort, mTimeout, mHandlerMap, noMatchHttpRequestHandler ,mWebSite, mListener);
    }
    ...
    public static final class Build {
        ...
        public Build noMatchHandler(HttpRequestHandler noMatchHttpRequestHandler) {
